 ...
 */
final class ReportReleaseContextResultRequestBuilder
{
	private $requestId;
	 ...
	 */
	public function build(): ReportReleaseContextResultRequest
	{
		$instance = new ReportReleaseContextResultRequest();
