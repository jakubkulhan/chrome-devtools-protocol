 ...
 */
final class ClearSharedStorageEntriesRequestBuilder
{
	private $ownerOrigin;
	 ...
	 */
	public function build(): ClearSharedStorageEntriesRequest
	{
		$instance = new ClearSharedStorageEntriesRequest();
