 ...
 */
final class SetContainerQueryConditionTextRequestBuilder
{
	 ...
	 */
	public function build(): SetContainerQueryConditionTextRequest
	{
		$instance = new SetContainerQueryConditionTextRequest();
