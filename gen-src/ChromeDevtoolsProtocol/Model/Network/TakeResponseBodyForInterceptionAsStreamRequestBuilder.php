 ...
 */
final class TakeResponseBodyForInterceptionAsStreamRequestBuilder
{
	 ...
	 */
	public function build(): TakeResponseBodyForInterceptionAsStreamRequest
	{
		$instance = new TakeResponseBodyForInterceptionAsStreamRequest();
